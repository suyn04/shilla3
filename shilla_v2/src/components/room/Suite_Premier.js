...
function Suite_Premier() {
    const galleryImgs = [
        "../../img/sub/roomSuitePremier01.jpg",
        "../../img/sub/roomSuitePremier02.jpg",
        "../../img/sub/roomSuitePremier03.jpg",
    ];

    const roomFloorImages = [
        {
            title: "프리미어 스위트 더블",
            src: "../../img/sub/roomSuitePremierFloor.jpg",
        }
    ];
    ...
    const roomIntro = [
        {
            title: "프리미어 스위트",
            description: "프리미어 스위트는 비즈니스 미팅과 프라이빗한 휴식을 동시에 즐길 수 있는 객실입니다.",
            subDescription: [
    ...
    const roomInfo = [
        ...
        {
            title: "룸구성",
            description: "침실 1, 욕실 1, 화장실 2, 응접실 1"
        },
        {
            title: "문의",
