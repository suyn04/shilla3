...
function Suite_Royal() {
    const galleryImgs = [
        "../../img/sub/roomSuiteRoyal01.jpg",
        "../../img/sub/roomSuiteRoyal02.jpg",
        "../../img/sub/roomSuiteRoyal03.jpg",
        "../../img/sub/roomSuiteRoyal04.jpg",
    ];

    const roomFloorImages = [
        {
            title: "로열 스위트 더블",
            src: "../../img/sub/roomSuiteRoyalFloor.jpg",
        }
    ];
    ...
    const roomIntro = [
        {
            title: "로열 스위트",
            description: "로열 스위트는 모던한 분위기의 고급스러운 공간으로 여유로운 응접실과 다이닝 룸, 업무 공간 및 침실로 구성된 객실입니다.",
            subDescription: [
    ...
    const roomInfo = [
        ...
        {
            title: "룸구성",
            description: "침실 1, 욕실 1, 화장실 2, 응접실 1, 다이닝 룸 1"
        },
        {
            title: "문의",
