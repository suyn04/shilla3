...
function Suite() {
    const galleryImgs = [
        "../../img/sub/roomSuiteSuperior01.jpg",
        "../../img/sub/roomSuiteSuperior02.jpg",
        "../../img/sub/roomSuiteSuperior03.jpg",
        "../../img/sub/roomSuiteSuperior04.jpg",
    ];

    const roomFloorImages = [
        {
            title: "수페리어 스위트 더블",
            src: "../../img/sub/roomSuiteSuperiorFloor.jpg",
        }
    ];
    ...
    const roomIntro = [
        {
            title: "수페리어 스위트",
            description: "수페리어 스위트는 영빈관이 내려다보이는 아늑하고 모던한 객실입니다.",
            subDescription: [
