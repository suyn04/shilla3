...
function Stand_GrandCornerDeluxe() {
    ...
    const galleryImgs = [
        ...
        "../../img/sub/roomStandardGrand02.jpg",
        "../../img/sub/roomStandardGrand03.jpg",
    ];

    const roomFloorImages = [
        {
            title: "그랜드 코너 디럭스 더블",
            src: "../../img/sub/roomStandardGrandFloor.jpg",
        },
    ];
...
export default Stand_GrandCornerDeluxe;