...
function Suite_Korean(props) {
    const galleryImgs = [
        ...
        "../../img/sub/roomSuiteKorean02.jpg",
        "../../img/sub/roomSuiteKorean03.jpg",
        "../../img/sub/roomSuiteKorean04.jpg",
    ];

    const roomFloorImages = [
        {
            title: "코리안 스위트 더블",
            src: "../../img/sub/roomSuiteKoreanFloor.jpg",
        }
    ];
    ...
    const roomIntro = [
        {
            title: "코리안 스위트",
            description: "코리안 스위트는 한국 전통의 미를 경험할 수 있는 서울신라호텔 유일의 온돌 객실입니다.",
            subDescription: [
                "한국 고유의 온돌 문화와 전통의 미(美)를 경험할 수 있습니다.",
                "외국인 고객분들은 물론 영∙유아를 동반한 가족 고객분들께 권해드립니다."
            ]
        }
    ];
